...
#define _00_CGC_OSCSTAB_STA0        (0x00U) /* < (2^8+16)/fX */
#define _80_CGC_OSCSTAB_STA8        (0x80U) /* (2^8+16)/fX */
#define _C0_CGC_OSCSTAB_STA9        (0xC0U) /* (2^9+16)/fX */
#define _E0_CGC_OSCSTAB_STA10       (0xE0U) /* (2^10+16)/fX */
#define _F0_CGC_OSCSTAB_STA11       (0xF0U) /* (2^11+16)/fX */
#define _F8_CGC_OSCSTAB_STA13       (0xF8U) /* (2^13+16)/fX */
#define _FC_CGC_OSCSTAB_STA15       (0xFCU) /* (2^15+16)/fX */
#define _FE_CGC_OSCSTAB_STA17       (0xFEU) /* (2^17+16)/fX */
#define _FF_CGC_OSCSTAB_STA18       (0xFFU) /* (2^18+16)/fX */

/*
    Oscillation stabilization time select register (OSTS)
*/
/* Oscillation stabilization time selection (OSTS2 - OSTS0) */
#define _00_CGC_OSCSTAB_SEL8        (0x00U) /* (2^8+16)/fX */
#define _01_CGC_OSCSTAB_SEL9        (0x01U) /* (2^9+16)/fX */
#define _02_CGC_OSCSTAB_SEL10       (0x02U) /* (2^10+16)/fX */
#define _03_CGC_OSCSTAB_SEL11       (0x03U) /* (2^11+16)/fX */
#define _04_CGC_OSCSTAB_SEL13       (0x04U) /* (2^13+16)/fX */
#define _05_CGC_OSCSTAB_SEL15       (0x05U) /* (2^15+16)/fX */
#define _06_CGC_OSCSTAB_SEL17       (0x06U) /* (2^17+16)/fX */
#define _07_CGC_OSCSTAB_SEL18       (0x07U) /* (2^18+16)/fX */
...
#define _00_CGC_IT_CLK_NO           (0x00U) /* stops clock supply */
