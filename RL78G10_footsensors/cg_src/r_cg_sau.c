...
void R_UART0_Create(void)
{
    ...
    SRPR10 = 1U;
    SRPR00 = 0U;
    SMR00L = _20_SAU_SMRMN_INITIALVALUE | _02_SAU_MODE_UART | _01_SAU_BUFFER_EMPTY;
    SMR00H = _00_SAU_CLOCK_SELECT_CK00 | _00_SAU_TRIGGER_SOFTWARE;
    SCR00L = _80_SAU_LSB | _10_SAU_STOP_1 | _07_SAU_LENGTH_8;
    SCR00H = _80_SAU_TRANSMISSION | _00_SAU_INTSRE_MASK | _02_SAU_PARITY_EVEN;
    SDR00H = _0E_UART0_TRANSMIT_DIVISOR;
    ...
    SCR01H = _40_SAU_RECEPTION | _00_SAU_INTSRE_MASK | _02_SAU_PARITY_EVEN;
    SDR01H = _0E_UART0_RECEIVE_DIVISOR;
...
/***********************************************************************************************************************
 * Function Name: R_UART0_TX_Start
 * Description  : This function starts the UART0 TX module operation.
 * Arguments    : None
 * Return Value : None
 ***********************************************************************************************************************/
void	R_UART0_TX_Start(void)
{
	SO0		|= _01_SAU_CH0_DATA_OUTPUT_1;			/* output level normal */
	SOE0	|= _01_SAU_CH0_OUTPUT_ENABLE;			/* enable UART0 output */
...
/***********************************************************************************************************************
 * Function Name: R_UART0_TX_Stop
 * Description  : This function stops the UART0 TX module operation.
 * Arguments    : None
 * Return Value : None
 ***********************************************************************************************************************/
void	R_UART0_TX_Stop(void)
{
	STMK0	= 1U;									/* disable INTST0 interrupt */
...
/***********************************************************************************************************************
 * Function Name: R_UART0_RX_Start
 * Description  : This function starts the UART0 RX module operation.
 * Arguments    : None
 * Return Value : None
 ***********************************************************************************************************************/
void	R_UART0_RX_Start(void)
{
	SS0		|= _02_SAU_CH1_START_TRG_ON;			/* enable UART0 receive */
	SRIF0	= 0U;									/* clear INTSR0 interrupt flag */
	SRMK0	= 0U;									/* enable INTSR0 interrupt */
}

/***********************************************************************************************************************
 * Function Name: R_UART0_RX_Stop
 * Description  : This function stops the UART0 RX module operation.
 * Arguments    : None
 * Return Value : None
 ***********************************************************************************************************************/
void	R_UART0_RX_Stop(void)
{
	SRMK0	= 1U;									/* disable INTSR0 interrupt */
